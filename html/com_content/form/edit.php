...
// Avoid conflict with Bootstrap4
$doc = JFactory::getDocument();
unset($doc->_styleSheets[$this->baseurl . '/media/jui/css/bootstrap-tooltip-extended.min.css']);
unset($doc->_scripts[$this->baseurl . '/media/jui/js/bootstrap-tooltip-extended.min.js']);
...
JFactory::getDocument()->addScriptDeclaration("
    ...
    jQuery(document).ready(function () {
        ...
        jQuery(document).on({
            ...
            mouseleave: function () {
                jQuery(this).attr('style', 'display:' + display + '!important;');
            },
            blur: function () {
                jQuery(this).attr('style', 'display:' + display + '!important;');
            }
